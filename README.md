...
1. On the Android device install the "Polar Sensor Logger" (PSL) App (cp. [1])
...
4. On the Android device ...
   ...
   * 3. Open "Polar Sensor Logger" App
     ...
     * 2. Under *"Settings:"* check `MQTT` solely
       * 1. In the pop-up *"MQTT-serttings"* configure
...
:-------------------------:|:-------------------------:|:-------------------------:
*Figure 4.1.: PSL, Main Tab* | *Figure 4.2.: PSL, Dialogue "MQTT Settings"* | *Figure 4.3.: PSL, Dialogue "Seek Sensor"*
...
TODO:*Listing 6.1.: Output Log of Map_PSL_Demo starting PIE*
```log
[...]
...
TODO:*Listing 6.2.: Output Log of Map_PSL_Demo stopping PIE*
```log
[...]
